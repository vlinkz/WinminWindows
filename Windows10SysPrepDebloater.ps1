#Modified from https://github.com/Sycnex/Windows10Debloater
...
Function Start-Debloat {
    ...
    [regex]$WhitelistedApps = 'Microsoft.WindowsStore|Microsoft.Windows.Photos|CanonicalGroupLimited.UbuntuonWindows|`
